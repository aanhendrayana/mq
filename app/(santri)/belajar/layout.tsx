  ...
  return (
    <KerangkaDasbor
      ...
      nav={[
        {
          item: [
            { href: "/belajar", label: "Kelas Saya", ikon: BookMarked, persis: true },
            { href: "/belajar/jadwal", label: "Jadwal Halaqah", ikon: CalendarDays },
            { href: "/belajar/rapor", label: "Rapor Tahsin", ikon: ChartLine },
        ...
        },
        {
          ...
          item: [
            ...
            { href: "/belajar/profil", label: "Profil", ikon: UserRound },
          ],
        },
      ]}
    >
